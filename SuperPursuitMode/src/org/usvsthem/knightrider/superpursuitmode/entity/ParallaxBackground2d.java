...
public class ParallaxBackground2d extends Background {
	...
	public static class ParallaxBackground2dEntity {
		...
		public ParallaxBackground2dEntity(final float pParallaxFactorX, final float pParallaxFactorY, final IAreaShape pShape) {
		...
		public ParallaxBackground2dEntity(final float pParallaxFactorX, final float pParallaxFactorY, final IAreaShape pShape, final Boolean pRepeatX, final Boolean pRepeatY) {
			this.mParallaxFactorX = pParallaxFactorX;
			this.mParallaxFactorY = pParallaxFactorY;
		...
		public ParallaxBackground2dEntity(final float pParallaxFactorX, final float pParallaxFactorY, final IAreaShape pShape, final Boolean pRepeatX, final Boolean pRepeatY, final Boolean pShouldCull) {
			this.mParallaxFactorX = pParallaxFactorX;
			this.mParallaxFactorY = pParallaxFactorY;
			this.mRepeatX = pRepeatX;
			this.mRepeatY = pRepeatY;
